...
namespace Microsoft.MixedReality.Toolkit.Audio
{
    ...
    public class TextToSpeech : MonoBehaviour
    {
        ...
        public string GetText()
        {
            ...
            else if (counter > 3) { FinishSpeaking(); }
        ...
        public void Speak()
        {
            //Get the corresponding output to the position
            string text = GetText();
        ...
        {
            counter = 0;        //set position to the beginning
            Speak();            //synthetize speech
        }
        ...
        {
            string text = "Well done and see you soon.";
            // Pass to helper method
#if WINDOWS_UWP
            PlaySpeech(text, ()=> synthesizer.SynthesizeTextToStreamAsync(text));
#else
